...
export const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "OPTION:C. FAQ 5개 선정|사용자 의도를 반영한 텍스트 블록 (카테고리 노출 여부)|<strong>필터 사용 및 관리</strong>: 필터는 얼마나 자주 교체해야 하나요?|<strong>제품 사용법</strong>: 닭뼈나 생선뼈도 갈리나요?|<strong>제품 사용법</strong>: 처리 중 음식물을 추가 투입해도 되나요?|<strong>제품 문의</strong>: 작동 시 소음은 어느 정도인가요?|<strong>제품 문의</strong>: 처리 완료까지 시간은 얼마나 걸리나요?",
      "OPTION:D. 스펙/인증 요약 영역|핵심 제품 정보를 요약한 텍스트 블록|대표 제품(블루벤트 ID) 단일 모델 중심 구성|무무 / S 포함 전 라인업 통합 요약 구성|주요 국가/AI 관련 인증 정보 포함 여부"
    ],
