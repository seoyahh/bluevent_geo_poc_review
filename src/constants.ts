...
export const SLIDES: Slide[] = [
  ...
  {
    id: 2,
    title: "Overview: PoC 목적 및 범위 재확인",
    oneLiner: "IA 현행 유지 하에 테크니컬 GEO 신호 강화를 통한 AI 인용률 극대화",
    bullets: [
      "목적: 진단 결과 공유, 가설 수립, PoC 수행방안 합의",
      "범위: 메인 홈페이지 및 블루벤트 ID 제품 상세페이지 집중 개선",
      "핵심 전략: 기술적 구조 개선(Technical SEO)을 통한 AI 크롤링 및 인식 정확도 향상"
    ],
    visualGuide: "PoC 범위를 시각화한 다이어그램 (Main Page + Product Page 중심)."
  },
  {
    id: 3,
    title: "Current Status (1): AI 인용 현황 진단 프레임워크",
    oneLiner: "브랜드 실체, 카테고리 추천, 제품 스펙 정확도를 아우르는 5대 핵심 질문 세트 설계",
    bullets: [
      "진단 목적: 주요 AI 플랫폼(ChatGPT, Perplexity, Gemini, Claude) 내 브랜드 인지 및 인용 정확도 측정",
      "질문 카테고리: 브랜드 실체 인식(Q1), 비브랜드 쿼리 기반 추천(Q2-4), 제품 스펙 정확도(Q5)",
      "수집 항목: 언급 유무, 인용 URL, 정보 정확도, 오류/누락 패턴"
    ],
    visualGuide: "질문 카테고리별 아이콘과 핵심 문항 리스트를 배치한 인포그래픽."
  },
  {
    id: 4,
    title: "Current Status (2): AI 모델별 인용률 분석 결과",
    oneLiner: "모델별 인용률 편차 확인 및 자사몰 데이터 인용 누락 현황 식별",
    bullets: [
      "인용률 매트릭스: ChatGPT/Claude의 낮은 인용률 vs Perplexity/Gemini의 상대적 노출",
      "출처 분석: 자사몰 공식 페이지보다 외부 블로그/리뷰 인용 비중이 높은 현상 발견",
      "주요 이슈: 제품 스펙의 부정확한 인지 및 경쟁사 브랜드와의 혼선 사례"
    ],
    visualGuide: "모델별/질문별 인용 유무를 보여주는 히트맵(Heatmap) 또는 매트릭스 표."
  },
  {
    id: 5,
    title: "Current Status (3): 인사이트 및 상위 가설 수립",
    oneLiner: "테크니컬 구조 개선이 AI 인용 확률과 정확도를 결정짓는 핵심 레버임을 확인",
    bullets: [
      "핵심 발견: AI가 '읽을 수 있는' 텍스트 정보 부재 시 사실 오류 및 인용 누락 발생",
      "상위 가설: 메인 및 상세페이지의 테크니컬 구조 최적화 시 AI 인용률 및 정확도 동반 상승",
      "PoC 집중 근거: 자사몰 공식 데이터의 신뢰도 확보를 위한 구조화(JSON-LD, H-tag) 필수"
    ],
    visualGuide: "'현상(Low Citation) -> 원인(Technical Gap) -> 가설(Optimization)' 흐름의 로직 트리."
  },
  {
    id: 6,
